...
from src.frontend.telegram.handlers.utils.messages import MESSAGES_ACTION_GET_PRODUCTS_BY_EXP_DATE, MESSAGES_MAIN
...
@check_authentication_decorator
@BOT.message_handler(
    func=lambda m: m.text == KEYBOARD_LIST_ACTIONS.action_get_products_by_exp_date,
